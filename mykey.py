# ══════════════════════════════════════════════════════════════════════════════
#  ai-coder — mykey.py 配置模板（复制为 mykey.py 后填入真实凭证）
# ══════════════════════════════════════════════════════════════════════════════
#
#  ┌─────────────────────────────────────────────────────────────────────────┐
#  │ 快速上手：只需 3 步                                                      │
...
mixin_config = {
    ...
    'llm_nos': ['minimax-m3:cloud'],   # 按优先级排列；Claude 与 GPT 混用
...
native_oai_config = {
    ...
    'name': 'minimax-m3:cloud',                           # /llms 显示名 & mixin 引用名
    # 'apikey': 'sk-<your-openai-key>',                # Bearer 鉴权
    'apikey': 'ollama-local"',                # Bearer 鉴权
    # 'apibase': 'https://api.openai.com/v1',          # 补齐到 /v1/chat/completions
    'apibase': 'http://127.0.0.1:11434/v1',          # 补齐到 /v1/chat/completions
    # 'model': 'gpt-5.4',                              # gpt-5/o 系列
    'model': 'minimax-m3:cloud',                              # gpt-5/o 系列
...
qq_app_id = '1904119391'
qq_app_secret = 'XzEFDzYu26xay84l'
